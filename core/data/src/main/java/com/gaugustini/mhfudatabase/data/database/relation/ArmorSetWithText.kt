...
/**
 * Represents an armor set entity with its associated text, defense and resistances values.
 */
data class ArmorSetWithText(
    @Embedded val armorSet: ArmorSetEntity,
    @Embedded val armorSetText: ArmorSetTextEntity,
    val defense: Int,
    val maxDefense: Int,
    val fire: Int,
    val water: Int,
